...
CREATE TABLE `user_profile` (
  ...
  `diet_type` VARCHAR(50) DEFAULT NULL COMMENT '饮食类型: omnivore/vegetarian/vegan/keto/etc',
  `diet_allergies` JSON DEFAULT NULL COMMENT '过敏原列表 JSON',
  `health_goals` JSON DEFAULT NULL COMMENT '健康目标: {weight, exercise, sleep, water, diet}',
  `sleep_preference` VARCHAR(50) DEFAULT NULL COMMENT '睡眠偏好: early_bird/night_owl',
  `activity_level` VARCHAR(50) DEFAULT NULL COMMENT '活动水平: sedentary/light/moderate/active/very_active',
